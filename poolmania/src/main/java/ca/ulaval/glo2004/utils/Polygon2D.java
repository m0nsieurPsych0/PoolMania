...
public class Polygon2D implements Shape, Cloneable, Serializable {
    ...
    /**
     * Méthode rajouté manuellement pour translate
     * @param deltaX
     * @param deltaY
     */
    public void translate(double deltaX, double deltaY){
        int i = npoints;
             ...
             if (bounds != null)
                   {
                       bounds.getBounds().x += deltaX;
                       bounds.getBounds().y += deltaY;
                   }
    }
    ...
    public void updatePath(double x, double y) {
        closedPath = null;
        if (path == null) {
